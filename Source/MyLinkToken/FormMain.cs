...
namespace MyLinkToken
{
    public partial class FormMain : Form
    {
        ...
        {
            this.Text = "MyLinkToken - 链克口袋   V" + Application.ProductVersion+ " QQ：5533673";
            BindAccount();
            ...
            this.TopLevel = true;
            LogMessage("欢迎使用 MyLinkToken - 链克口袋\r\n天天玩客币交易: ttwkc.cc ");
        }
        ...
        void listBoxAccount_SelectedIndexChanged(object sender, EventArgs e)
        {
            this.Enabled = false;
            ...
            var ini = new iHomeSoft.Helper.iniHelper(Application.StartupPath + "\\rename.ini");
        ...
        void txtToNum_Validating(object sender, CancelEventArgs e)
        {
            
        }

        void txtToNum_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        {
            Process.Start("http://www.ttwkc.cc");
        }
